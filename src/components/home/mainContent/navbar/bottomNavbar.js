                ...
                <div className="container">
                    <div className="header-left">
                        <a href="demo13.html" className="header-logo bg-white">
                            <img src="assets/images/demos/demo13/logo.png" alt="logo" style={{width:"145px",  height: "45px"}} />
                        </a>
                        ...
                        <div className="dropdown">
                            <a href="#language"><img src="assets/images/flags/eng.png" alt="ENG Flag" style={{width:"14px",  height: "8px"}} className="dropdown-image" /> ENG
                            </a>
                            <div className="dropdown-box">
                                <a href="#ENG">
                                    <img src="assets/images/flags/eng.png" alt="ENG Flag" style={{width:"14px",  height: "8px"}}
                                        className="dropdown-image" />
                                    ENG
                                </a>
                                <a href="#FRA">
                                    <img src="assets/images/flags/fra.png" alt="FRA Flag" style={{width:"14px",  height: "8px"}}
                                        className="dropdown-image" />
                                    FRA
                                </a>
                            </div>
