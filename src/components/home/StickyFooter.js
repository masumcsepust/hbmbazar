...
const StrickyFooter = () => {
    return (
        ...
        <a href="demo13.html" className="sticky-link active">
            <i className="w-icon-home"></i>
            <p>Home</p>
        </a>
        <a href="demo13-shop.html" className="sticky-link">
            ...
            <div className="dropdown-box">
                <div className="products">
                    <div className="product product-cart">
                        ...
                        <figure className="product-media">
                            <a href="product-default.html">
                                <img src="assets/images/cart/product-1.jpg" alt="product" style={{height:"84px", width:"94px"}} />
                            </a>
                        </figure>
                    ...
                    <div className="product product-cart">
                        ...
                        <figure className="product-media">
                            <a href="product-default.html">
                                <img src="assets/images/cart/product-2.jpg" alt="product" style={{height:"84px", width:"94px"}} />
                            </a>
                        </figure>
                        <button className="btn btn-link btn-close">
                            <i className="fas fa-times"></i>
